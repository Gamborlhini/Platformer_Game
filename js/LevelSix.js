...
function winRedirect() {
  if (winblock == true) {
    location.assign("../html/LevelSeven.html");
  }
}
...
function drawNew() {
  ...
  ctx.fillStyle = "black";
  ctx.font = "20px Arial"
  ctx.fillText(`The mortar shoots at where you were when it shot`, 20, 30)
  ctx.fillText('If you get hit, you lose half your life', 20, 55)
  ctx.fillText('You cannot destroy the mortar', 20, 80)

...
function drawNew() {
 ...
 var coin3 = {
  ...
  ctx.fillStyle = "black";
  ctx.font = "20px Arial"
  ctx.fillText(`Collect all three coins to summon a portal to the next level`, 20, 30)
  ctx.fillText(`Use WASD to move around`, 20, 55)
